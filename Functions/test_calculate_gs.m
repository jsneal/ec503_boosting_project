...
% load('C:\Users\jsnea\Desktop\EC503\Project\ec503_boosting_project\Datasets\synthetic\linearly_separable_not_by_stump.mat');
% 
% all_gs = calculate_gs(data);
% 
% figure(1)
...
% load('C:\Users\jsnea\Desktop\EC503\Project\ec503_boosting_project\Datasets\synthetic\circular_dataset.mat');
% data = data_circular;
% all_gs = calculate_gs(data);
% 
% figure(1)
